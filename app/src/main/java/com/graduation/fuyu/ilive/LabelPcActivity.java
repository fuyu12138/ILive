...
public class LabelPcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWindow();
        setContentView(R.layout.activity_label_pc);
        toolbar=findViewById(R.id.activity_label_pc_toolbar);
        labelRecyclerView=findViewById(R.id.activity_label_pc_rv_already);
        arrow=findViewById(R.id.activity_label_pc_iv_arrow);
        smallRecyclerView=findViewById(R.id.activity_label_pc_rv_small);
        mRecyclerView=findViewById(R.id.activity_label_pc_rv_card);
        ...
        labelLayoutManager=new GridLayoutManager(LabelPcActivity.this,3);
        labelRecyclerView.setLayoutManager(labelLayoutManager);
        labelBeans=new ArrayList<>();
        Label label=new Label();
        labelBeans= label.getPcGameBeanBean();
        labelAdapter=new LabelRecyclerAdapter2(LabelPcActivity.this, labelBeans);
        ...
        smallAdapter=new LabelRecyclerAdapter(LabelPcActivity.this,labelBeans);
        ...
        mSwipeLayout=findViewById(R.id.activity_label_pc_swipe);
        ...
        mLayoutManager=new GridLayoutManager(LabelPcActivity.this,2);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mAdapter=new LiveRoomRecyclerAdapter(LabelPcActivity.this, liveRooms);
    ...
    private void initData(List<String> labels){
        for (int i=0;i<12;i++){
            String label="英雄联盟"+String.valueOf(i);
            labels.add(label);
        }
    }
}
