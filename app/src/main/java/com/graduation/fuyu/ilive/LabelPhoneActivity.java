...
public class LabelPhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWindow();
        setContentView(R.layout.activity_label_phone);
        toolbar=findViewById(R.id.activity_label_phone_toolbar);
        labelRecyclerView=findViewById(R.id.activity_label_phone_rv_already);
        arrow=findViewById(R.id.activity_label_phone_iv_arrow);
        smallRecyclerView=findViewById(R.id.activity_label_phone_rv_small);
        mRecyclerView=findViewById(R.id.activity_label_phone_rv_card);
        ...
        labelLayoutManager=new GridLayoutManager(LabelPhoneActivity.this,3);
        labelRecyclerView.setLayoutManager(labelLayoutManager);
        labelBeans=new ArrayList<>();
        Label label=new Label();
        labelBeans= label.getphoneGameBean();
        labelAdapter=new LabelRecyclerAdapter2(LabelPhoneActivity.this, labelBeans);
        ...
        smallAdapter=new LabelRecyclerAdapter(LabelPhoneActivity.this,labelBeans);
        ...
        mSwipeLayout=findViewById(R.id.activity_label_phone_swipe);
        ...
        mLayoutManager=new GridLayoutManager(LabelPhoneActivity.this,2);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mAdapter=new LiveRoomRecyclerAdapter(LabelPhoneActivity.this, liveRooms);
    ...
    private void initData(List<String> labels){
        for (int i=0;i<12;i++){
            String label="王者荣耀"+String.valueOf(i);
            labels.add(label);
        }
    }
}
