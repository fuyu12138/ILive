...
public class SetFrontCoverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWindow();
        setContentView(R.layout.activity_set_front_cover);
        front_cover=findViewById(R.id.activity_front_cover_im);
        gallery=findViewById(R.id.activity_front_cover_btn_gallery);
        camera=findViewById(R.id.activity_front_cover_btn_camera);
        toolbar=findViewById(R.id.activity_front_cover_toolbar);
        Glide.with(this).load("http://139.196.124.195:8080/LoginServer/cover/"+FileName).dontAnimate().placeholder(R.mipmap.default1).error(R.mipmap.default1).into(front_cover);
    ...
    private void requestPermission() {
        PermissionsUtil.requestPermission(getApplication(), new PermissionListener() {
            ...
            public void permissionDenied(@NonNull String[] permissions) {
                Toast.makeText(SetFrontCoverActivity.this, "请求权限失败", Toast.LENGTH_LONG).show();
            }
...
//                Log.e("crop1", Constants.ImageTempPath);
    ...
    class UpLoadImage extends AsyncTask<String,Void,Boolean>{
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            if(!isGrantExternalRW(SetFrontCoverActivity.this)){
                return null;
            }
            return hClient.UpLoadFile(url,username);
        }
        ...
        protected void onPostExecute(Boolean aBoolean) {
            if (aBoolean){
                ...
                Toast.makeText(SetFrontCoverActivity.this,"设置失败",Toast.LENGTH_SHORT).show();
            }
        }
    }
    /**
            ...
            for (int i = 0; i < permissions.length; i++) {
                ...
                if (permission.equals(Manifest.permission.READ_EXTERNAL_STORAGE)) {
                    if (grantResult == PackageManager.PERMISSION_GRANTED) {
                        ...
                        SetFrontCoverActivity.this.requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, PERMISSIONS_CODE);
                    }
                }
            }
        }
