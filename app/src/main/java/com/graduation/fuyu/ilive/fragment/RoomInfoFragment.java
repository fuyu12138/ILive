 ...
 * {@link RoomInfoFragment.OnFragmentInteractionListener} interface
...
public class RoomInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView=view.findViewById(R.id.fragment_room_info_tv);
        if ((getActivity()) != null) {
            introduce=((LiveRoomActivity)getActivity()).getIntroduce();
